...
const navigationLinks = [
  { name: 'Home', href: '/clinic-index' },
  { name: 'About Us', href: '/clinic-aboutus/' },
  { name: 'Services', href: '/clinic-services/' },
  { name: 'Gallery', href: '/clinic-gallery/' },
  { name: 'Make Appointment', href: '/clinic-contactapp/' },
  { name: 'Contact Us', href: '/clinic-contact/' },
]
