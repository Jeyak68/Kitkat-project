...
class Footer extends Component {
    render() {
        return (
            ...
            <footer>
            <div class="grid grid-cols-4 gap-8 px-6 py-8">
            <div>
                    <h2 class="mb-6 text-2xl font-semibold uppercase text_white">Services</h2>
                        <p class="text-xl footer_text pb-2">Glaucoma </p>
                        <p class="text-xl footer_text pb-2">Cataract Surgery </p>
                        <p class="text-xl footer_text pb-2">Ophthalmology </p>
                        <p class="text-xl footer_text">Diabetic Eye Care</p>
                </div>
                <div>
