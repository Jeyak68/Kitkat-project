...
const navigationLinks = [
  { name: 'AAYUSH POLYCLINIC', href: '/clinic-index/' },
  { name: 'BALAJI EYE HOSPITAL', href: '/eye-index/' },
  { name: 'BALAJI ENTERPRISE & EXPORT', href: '/shop-index/' },
            ...
            <div className="max-w-7xl mx-auto px-2 sm:px-12 lg:px-8 relative flex items-center justify-between h-20">
              ...
              <div className="flex-1 flex items-center justify-center lg:items-stretch lg:justify-start">
                ...
                <div className="hidden lg:block lg:ml-8 xl:ml-12 2xl:ml-16">
                  <nav className="flex space-x-3 mt-4 text-2xl">
